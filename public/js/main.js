...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)().ready(function () {
	  ...
	  var $navMain = (0, _jquery2.default)('.nav-main');
	  var $mobileNavToggleButton = (0, _jquery2.default)('.nav-toggle');
	  ...
	  if ($navMain.data('nav-small')) {
	    ...
	    (0, _jquery2.default)(window).on('scroll', (0, _lodash2.default)(scrollHandler, 250));
	  }
	  ...
	  var $navLinks = (0, _jquery2.default)('.nav-home__link');
	  ...
	  function setActive(links, currentElem) {
	    clearActive(links);
	    (0, _jquery2.default)(currentElem).addClass('active');
	  }
	  ...
	  var $sectionsObject = sectionsList.map(function (section) {
	    var id = "#" + section;
	    var $jqueryObj = (0, _jquery2.default)(id)[0];
	  ...
	  (0, _jquery2.default)(window).on('resize', updateViewportHeight);
	  (0, _jquery2.default)(window).on('scroll', (0, _lodash2.default)(scrollSpy, 250));
	});
